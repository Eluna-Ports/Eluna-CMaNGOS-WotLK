...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_VALGARDE70_LEVEL,
    CONFIG_UINT32_UTGARDEPINNACLE_LEVEL,
    CONFIG_UINT32_NEXUS70_LEVEL,
    CONFIG_UINT32_NEXUS80_LEVEL,
    CONFIG_UINT32_STRATHOLMECOT_LEVEL,
    CONFIG_UINT32_ULDUAR70_LEVEL,
    CONFIG_UINT32_DRAKTHERONKEEP_LEVEL,
    CONFIG_UINT32_AZJOL_UPPERCITY_LEVEL,
    CONFIG_UINT32_ULDUAR80_LEVEL,
    CONFIG_UINT32_ULDUARRAID_LEVEL,
    CONFIG_UINT32_GUNDRAK_LEVEL,
    CONFIG_UINT32_DALARANPRISON_LEVEL,
    CONFIG_UINT32_CHAMBEROFASPECTSBLACK_LEVEL,
    CONFIG_UINT32_NEXUSRAID_LEVEL,
    CONFIG_UINT32_AZJOL_LOWERCITY_LEVEL,
    CONFIG_UINT32_ICECROWNCITADEL_LEVEL,
    CONFIG_UINT32_ICECROWNCITADEL5MAN_LEVEL,
    CONFIG_UINT32_ARGENTTOURNAMENTRAID_LEVEL,
    CONFIG_UINT32_ARGENTTOURNAMENTDUNGEON_LEVEL,
    CONFIG_UINT32_QUARRYOFTEARS_LEVEL,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_VALGARDE70_DIFF,
    CONFIG_FLOAT_UTGARDEPINNACLE_DIFF,
    CONFIG_FLOAT_NEXUS70_DIFF,
    CONFIG_FLOAT_NEXUS80_DIFF,
    CONFIG_FLOAT_STRATHOLMECOT_DIFF,
    CONFIG_FLOAT_ULDUAR70_DIFF,
    CONFIG_FLOAT_DRAKTHERONKEEP_DIFF,
    CONFIG_FLOAT_AZJOL_UPPERCITY_DIFF,
    CONFIG_FLOAT_ULDUAR80_DIFF,
    CONFIG_FLOAT_ULDUARRAID_DIFF,
    CONFIG_FLOAT_GUNDRAK_DIFF,
    CONFIG_FLOAT_DALARANPRISON_DIFF,
    CONFIG_FLOAT_CHAMBEROFASPECTSBLACK_DIFF,
    CONFIG_FLOAT_NEXUSRAID_DIFF,
    CONFIG_FLOAT_AZJOL_LOWERCITY_DIFF,
    CONFIG_FLOAT_ICECROWNCITADEL_DIFF,
    CONFIG_FLOAT_ICECROWNCITADEL5MAN_DIFF,
    CONFIG_FLOAT_ARGENTTOURNAMENTRAID_DIFF,
    CONFIG_FLOAT_ARGENTTOURNAMENTDUNGEON_DIFF,
    CONFIG_FLOAT_QUARRYOFTEARS_DIFF,
    ...
    //WotLK Heroic Instances
    CONFIG_FLOAT_HEROIC_STRATHOLMERAID_DIFF,
    CONFIG_FLOAT_HEROIC_VALGARDE70_DIFF,
    CONFIG_FLOAT_HEROIC_UTGARDEPINNACLE_DIFF,
    CONFIG_FLOAT_HEROIC_NEXUS70_DIFF,
    CONFIG_FLOAT_HEROIC_NEXUS80_DIFF,
    CONFIG_FLOAT_HEROIC_STRATHOLMECOT_DIFF,
    CONFIG_FLOAT_HEROIC_ULDUAR70_DIFF,
    CONFIG_FLOAT_HEROIC_DRAKTHERONKEEP_DIFF,
    CONFIG_FLOAT_HEROIC_AZJOL_UPPERCITY_DIFF,
    CONFIG_FLOAT_HEROIC_ULDUAR80_DIFF,
    CONFIG_FLOAT_HEROIC_ULDUARRAID_DIFF,
    CONFIG_FLOAT_HEROIC_GUNDRAK_DIFF,
    CONFIG_FLOAT_HEROIC_DALARANPRISON_DIFF,
    ...
    CONFIG_FLOAT_HEROIC_ICECROWNCITADEL5MAN_DIFF,
    CONFIG_FLOAT_HEROIC_ARGENTTOURNAMENTRAID_DIFF,
    CONFIG_FLOAT_HEROIC_ARGENTTOURNAMENTDUNGEON_DIFF,
    CONFIG_FLOAT_HEROIC_QUARRYOFTEARS_DIFF,
    CONFIG_FLOAT_HEROIC_HALLSOFREFLECTION_DIFF,
    CONFIG_FLOAT_HEROIC_CHAMBEROFASPECTSRED_DIFF,
    //Special Cases
    CONFIG_FLOAT_HEROIC_ARGENTTOURNAMENTRAID10_DIFF,
